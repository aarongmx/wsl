      ...
      <div class="vx-col w-full md:w-3/5 lg:w-3/4 mt-12 md:mt-0">
        <vx-card>
          ...
          <div class="article-title mb-6">
            ...
            <p class="mt-1">
              Last updated on
              <span>{{ article.lastUpdated | date(true) }}</span>
            </p>
          </div>
          ...
          <p
            class="mb-6"
          >Candy canes oat cake biscuit halvah ice cream. Marshmallow icing topping toffee caramels dessert carrot cake. Liquorice soufflé brownie sugar plum dessert cotton candy. Cupcake halvah topping oat cake soufflé pastry dragée pudding cotton candy.</p>
